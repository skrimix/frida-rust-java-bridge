...
| Typed facade argument/return helpers | Done | `FromJavaValue`, `FromImplementationReturn`, `IntoImplementationReturn`, `ImplementationReturn` | Primitive conversions, typed argument extraction, object/object-array borrowed returns, and null-reference handling are covered through the public closure trampoline path. |
