...
impl Env<'_> {
    ...
    /// # Safety
    ///
    /// `constructor` must have been resolved from `class` in this process's ART runtime, and every object reference
    ...
    /// # Safety
    ///
    /// `method` must have been resolved from `object`'s class or one of its supertypes in this process's ART runtime,
    ...
    /// # Safety
    ///
    /// `method` must have been resolved from `class` in this process's ART runtime, and every object reference in
