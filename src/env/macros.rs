...
macro_rules! primitive_instance_method_calls_from_entries {
    ($(
        ...
        $(
            ...
            /// this process's ART runtime, and every object reference in `args` must be valid for this attached
...
macro_rules! primitive_static_method_calls_from_entries {
    ($(
        ...
        $(
            ...
            /// # Safety
            ///
            /// `method` must have been resolved from `class` in this process's ART runtime, and every object
...
macro_rules! primitive_static_fields_from_entries {
    ($(
        ...
        $(
            ...
            /// # Safety
            ///
            /// `field` must have been resolved from `class` in this process's ART runtime.
            pub unsafe fn $get_name(
                &self,
                class: &impl AsJClass,
                field: &FieldId,
