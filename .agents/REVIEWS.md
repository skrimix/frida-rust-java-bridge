...
Status: Partially handled. Class-loader and loaded-class enumeration now return ART-owned raw handle records from [src/art/backend.rs](/home/skrimix/work/frida/frida-java-bridge-rs/src/art/backend.rs:243), with wrapper conversion moved to the Java facade in [src/java/handle.rs](/home/skrimix/work/frida/frida-java-bridge-rs/src/java/handle.rs:266). The new internal handle DTOs live in [src/art/enumeration.rs](/home/skrimix/work/frida/frida-java-bridge-rs/src/art/enumeration.rs:46). Method-query metadata and heap instance callback delivery still intentionally depend on Java facade types and remain follow-up work. Verification passed with `cargo fmt --check`, `just host-test`, `just check`, `just unit-test-build`, `just app-process-test-build`, and `just app-test all` on connected SDK 34 and SDK 29 devices.
