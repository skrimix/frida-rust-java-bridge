...
Status: Handled. Hook return ownership, conversion, and return validation live in [src/replacement/returns.rs](/home/skrimix/work/frida/frida-java-bridge-rs/src/replacement/returns.rs:1), hook argument inspection/conversion lives in [src/replacement/arguments.rs](/home/skrimix/work/frida/frida-java-bridge-rs/src/replacement/arguments.rs:1), hook installation/admission lives in [src/replacement/install.rs](/home/skrimix/work/frida/frida-java-bridge-rs/src/replacement/install.rs:1), safe constructor hook context/token APIs live in [src/replacement/constructor.rs](/home/skrimix/work/frida/frida-java-bridge-rs/src/replacement/constructor.rs:1), and method hook invocation context now lives in [src/replacement/context.rs](/home/skrimix/work/frida/frida-java-bridge-rs/src/replacement/context.rs:1). Public exports stay stable through [src/replacement/mod.rs](/home/skrimix/work/frida/frida-java-bridge-rs/src/replacement/mod.rs:23), [src/replacement/api.rs](/home/skrimix/work/frida/frida-java-bridge-rs/src/replacement/api.rs:1) now owns only the guard/error/set/target facade, and the large facade-level unit suite was moved to [src/replacement/tests.rs](/home/skrimix/work/frida/frida-java-bridge-rs/src/replacement/tests.rs:1). Verification passed with `cargo fmt --check`, `just host-test`, `just check`, `just unit-test-build`, and `just test all` on connected SDK 34 and SDK 29.
