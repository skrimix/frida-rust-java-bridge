...
| Partial | Cognitive Overload — `ArtBackend` is a symbol registry, capability checker, and feature executor at once | Moved method-replacement support, install, restore, and prerequisite probing into `src/art/replacement.rs`; enumeration and heap support now live beside their backend behavior. The broad symbol bag remains for a later pass. |
...
Progress counts: Done 7 / Partial 3 / Open 1 / Total 11.
