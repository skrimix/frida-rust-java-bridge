...
Status: Partially handled. Class-loader and loaded-class enumeration now return ART-owned raw handle records from [src/art/backend.rs](/home/skrimix/work/frida/frida-java-bridge-rs/src/art/backend.rs:243), with wrapper conversion moved to the Java facade in [src/java/handle.rs](/home/skrimix/work/frida/frida-java-bridge-rs/src/java/handle.rs:266). Method-query enumeration now also returns ART-owned groups and method records from [src/art/enumeration.rs](/home/skrimix/work/frida/frida-java-bridge-rs/src/art/enumeration.rs:78), with public metadata/class-loader conversion in [src/java/handle.rs](/home/skrimix/work/frida/frida-java-bridge-rs/src/java/handle.rs:302) and shared query parsing/matching in [src/method_query.rs](/home/skrimix/work/frida/frida-java-bridge-rs/src/method_query.rs:1). Heap instance callback delivery still intentionally depends on Java facade types and remains follow-up work. Verification passed with `cargo fmt --check`, `just host-test`, `just check`, `just unit-test-build`, `just app-process-test-build`, and `just app-test all` on connected SDK 34 and SDK 29 devices.
