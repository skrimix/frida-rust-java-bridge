...
Status: In progress. The replacement harness entrypoint was split into behavior-named scenario helpers in [src/app_process_test/replacement_checks.rs](/home/skrimix/work/frida/frida-java-bridge-rs/src/app_process_test/replacement_checks.rs:5): constructor replacement, overload facade replacement, stack visitor compatibility, static argument/return/original-call scenarios, instance scenarios, string/object/array return scenarios, error/panic handling, and int-array argument replacement. Verification passed with `cargo fmt --check`, `just check`, `just app-process-test-build`, and `just app-test all` on connected SDK 34 and SDK 29 devices. The broader finding remains open because [src/app_process_test/checks.rs](/home/skrimix/work/frida/frida-java-bridge-rs/src/app_process_test/checks.rs:767) still contains the app-loader megascript and some extracted replacement helpers are intentionally broad first slices.
